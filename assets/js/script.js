...
(function () {
    var filterInput = document.querySelector("[data-bibliography-filter]");
    var categories = Array.from(document.querySelectorAll("[data-bibliography-category]"));
    var emptyMessage = document.querySelector("[data-bibliography-empty]");
    ...
    function applyFilter() {
        ...
        categories.forEach(function (category) {
            var items = Array.from(category.querySelectorAll("li"));
            ...
            var showCategory = categoryVisibleCount > 0;
            category.hidden = !showCategory;
            category.setAttribute("aria-hidden", showCategory ? "false" : "true");
        });

        if (emptyMessage) {
            emptyMessage.hidden = totalVisibleCount !== 0;
        }
    }
