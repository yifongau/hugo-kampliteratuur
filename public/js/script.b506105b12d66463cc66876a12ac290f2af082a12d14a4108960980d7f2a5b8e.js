...
(function () {
    ...
    var bibliographyList = document.querySelector("[data-bibliography-list]");
    var emptyMessage = document.querySelector("[data-bibliography-empty]");

    if (!filterInput || !bibliographyList) {
        return;
    }

    var items = Array.from(bibliographyList.querySelectorAll("li"));
